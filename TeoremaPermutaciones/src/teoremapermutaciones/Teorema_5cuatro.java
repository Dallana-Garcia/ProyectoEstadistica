...
public class Teorema_5cuatro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt_n, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, 40, 40));

        jLabel4.setFont(new java.awt.Font("Corbel", 1, 36)); // NOI18N
        jLabel4.setText("_______________ =");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, -1, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teorema_5cuatro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teorema_5cuatro().setVisible(true);
            }
        });
    }
