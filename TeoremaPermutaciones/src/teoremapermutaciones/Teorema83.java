 ...
 * @author sgarc
 */
public class Teorema83 extends javax.swing.JFrame {
    TeoremaPermutaciones fondo = new TeoremaPermutaciones ();

    /**
     * Creates new form Teorema83
     */
    public Teorema83() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("P ( A U B U C U D ) = P (A) + P (B) + P (C) + P (D) + P(E) + P(F)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teorema83.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
