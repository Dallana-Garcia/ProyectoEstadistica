 ...
 * @author sgarc
 */
public class Teorema85 extends javax.swing.JFrame {
    TeoremaPermutaciones fondo = new TeoremaPermutaciones ();

    /**
     * Creates new form Teorema85
     */
    public Teorema85() {
    ...
    private void initComponents() {
        ...
        numero1.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel1.setText("P ( A U B U C U D ) = P (A) + P (B) + P (C) + P (D) + P(E) + P(F) + P (G) + P (H)");

        jLabel9.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        jLabel9.setText(") + P (");

        numero6.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N

        jLabel2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        jLabel2.setText("P ( ");

        numero3.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N

        jLabel10.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        jLabel10.setText(") + P (");

        numero2.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        numero7.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        numero4.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        ...
        numero5.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N

        jLabel11.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
        jLabel11.setText(") + P (");

        numero8.setFont(new java.awt.Font("Arial Rounded MT Bold", 1, 14)); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txtResultado.setText(String.valueOf(num1+num2+num3+num4+num5+num6+num7+num8));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teorema85.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
