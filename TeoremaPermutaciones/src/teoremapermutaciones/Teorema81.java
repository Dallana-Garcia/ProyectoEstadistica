 ...
 * @author sgarc
 */
public class Teorema81 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("P ( A U B U C U D ) = P (A) + P (B) + P (C) + P (D)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teorema81.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
