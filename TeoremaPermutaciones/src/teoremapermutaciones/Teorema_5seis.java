...
public class Teorema_5seis extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(txt_n, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 0, 40, 40));

        jLabel4.setFont(new java.awt.Font("Corbel", 1, 36)); // NOI18N
        jLabel4.setText("____________________ =");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 400, 40));

        txt_n3.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        jPanel1.add(txt_n3, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 60, 40, 40));
        ...
        jLabel11.setText("!");
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 20, 60));
        ...
        jLabel14.setText("!");
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 20, 60));

        txt_n4.setFont(new java.awt.Font("Corbel", 1, 14)); // NOI18N
        jPanel1.add(txt_n4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 60, 40, 40));

        jLabel15.setFont(new java.awt.Font("Corbel", 1, 36)); // NOI18N
        jLabel15.setText("!");
        jPanel1.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 50, 20, 60));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        factorialteorema5 fac7= new factorialteorema5(g);
        res1= fac1.imprimir();
        res2= fac2.imprimir();
        res3= fac3.imprimir();
        res4= fac4.imprimir();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Teorema_5seis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Teorema_5seis().setVisible(true);
            }
        });
    }
